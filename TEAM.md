...
| Hoàng Đức Minh | 2A202602362 | https://github.com/hoangminh92k3 | UI & tích hợp: làm bản web UI Gradio và smoke test riêng, mô tả trong mục INDIVIDUAL; web UI trong bản chốt (`starter_v0/web_ui.py`) do Dũng thực hiện | `TEAM.md` (mục INDIVIDUAL tự viết) — commit `7f08e2e` (16/09/2026 10:57 +07, tài khoản `hoangminh92k3`) |
